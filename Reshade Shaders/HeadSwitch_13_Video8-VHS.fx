...
// --- STRIPE 10 ---
uniform float Stripe10_BaseOff <
    ui_category = "Stripe 10";
    ui_type = "slider";
    ui_label = "Base Offset";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
> = -0.011;

uniform float Stripe10_JetMult <
    ui_category = "Stripe 10";
    ui_type = "slider";
    ui_label = "Burst Multiplier";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
...
uniform float Stripe10_SatMult <
    ui_category = "Stripe 10";
    ui_type = "slider";
    ui_label = "Saturation Multiplier";
    ui_min = 0.0; ui_max = 2.0; ui_step = 0.01;
...
// --- STRIPE 11 ---
uniform float Stripe11_BaseOff <
    ui_category = "Stripe 11";
    ui_type = "slider";
    ui_label = "Base Offset";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
> = -0.012;

uniform float Stripe11_JetMult <
    ui_category = "Stripe 11";
    ui_type = "slider";
    ui_label = "Burst Multiplier";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
...
uniform float Stripe11_SatMult <
    ui_category = "Stripe 11";
    ui_type = "slider";
    ui_label = "Saturation Multiplier";
    ui_min = 0.0; ui_max = 2.0; ui_step = 0.01;
...
// --- STRIPE 12 ---
uniform float Stripe12_BaseOff <
    ui_category = "Stripe 12";
    ui_type = "slider";
    ui_label = "Base Offset";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
> = -0.012;

uniform float Stripe12_JetMult <
    ui_category = "Stripe 12";
    ui_type = "slider";
    ui_label = "Burst Multiplier";
    ui_min = -0.1; ui_max = 0.1; ui_step = 0.001;
...
uniform float Stripe12_SatMult <
    ui_category = "Stripe 12";
    ui_type = "slider";
    ui_label = "Saturation Multiplier";
    ui_min = 0.0; ui_max = 2.0; ui_step = 0.01;
...
float4 PS_HeadSwitch(float4 vpos : SV_Position, float2 uv : TEXCOORD0) : SV_Target
{
    ...
    if (uv.y >= glitch_y_start)
    {
        ...
        switch (stripe_idx) {
            ...
            case 10: s_base_off = Stripe10_BaseOff; s_jet_mult = Stripe10_JetMult; s_sat_mult = Stripe10_SatMult; break;
            case 11: s_base_off = Stripe11_BaseOff; s_jet_mult = Stripe11_JetMult; s_sat_mult = Stripe11_SatMult; break;
            case 12: s_base_off = Stripe12_BaseOff; s_jet_mult = Stripe12_JetMult; s_sat_mult = Stripe12_SatMult; break;
